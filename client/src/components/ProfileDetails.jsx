...
import { Alert, Avatar, Box, Divider, Modal, Paper, Stack, TextField, Typography } from "@mui/material";
  ...
  return (
    ...
    <Stack  direction={"row"} justifyContent={"space-between"} spang={2} >
      ...
      <Box  flex={"8"} padding={2} sx={{ display:"flex", flexDirection:"row", position:"relative", justifyContent:"flex-start", mt:"40px"}}>
        ...
        >
      <Box sx={style}>
        <img className="profImg" src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Lionel_Messi_20180626.jpg" />
      </Box>
     </Modal>
      </Box>
