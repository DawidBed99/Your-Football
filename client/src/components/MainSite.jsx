   ...
   <ShareIcon />
    ...
    return(
        <Box  flex={"4"} padding={2} sx={{ display:"flex",alignItems:"center", flexDirection:"column"}}>
          <Paper sx={{display:"flex", justifyContent:"center", padding:"10px", width:"90%"}}><Typography textAlign="center" fontSize="48px" fontWeight="600"color="danger" >Latest news</Typography></Paper>
          <Box>
         {postsList}
    </Box>
        </Box>
